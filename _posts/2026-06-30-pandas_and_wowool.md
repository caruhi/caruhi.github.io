...
We will show you here how easy it is to extract information and enrich your files using Wowool. For this particular example we will be using python and the pandas library. 
